# ATC-SCAF-VOC — Course Specification

**Status:** 0.0-stub (local scaffold only)  
**Official name:** Verification of Competency  
**Provisional duration:** 1 day target  
**Governing encyclopedia:** Scaffolding-Grokapedia Ch20 + Master Control Register  
**Owner:** Anabeeb Training Center (ATC) / QHSSE

## Intent

Periodic reassessment against critical practical items + short theory.
