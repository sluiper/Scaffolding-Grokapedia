# ATC-SCAF-BASIC — Course Specification

**Status:** 0.0-stub (local scaffold only)  
**Official name:** New Scaffolder Basic (Module-1 alignment)  
**Provisional duration:** multi-day (TBD)  
**Governing encyclopedia:** Scaffolding-Grokapedia Ch20 + Master Control Register  
**Owner:** Anabeeb Training Center (ATC) / QHSSE

## Intent

Core erect/modify/dismantle basics aligned to Anabeeb Module-1 topics: components, terminology, types, ties, access, bad practices, tags.
