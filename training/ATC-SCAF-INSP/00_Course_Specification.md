# ATC-SCAF-INSP — Course Specification

**Status:** 0.0-stub (local scaffold only)  
**Official name:** Scaffold Inspector  
**Provisional duration:** TBD  
**Governing encyclopedia:** Scaffolding-Grokapedia Ch20 + Master Control Register  
**Owner:** Anabeeb Training Center (ATC) / QHSSE

## Intent

Handover inspection, tagging authority, defect recognition, duty class verification.
