...
| ID | Document | Status |
|----|----------|--------|
| SRC-ANB-OPS-SCAF | Anabeeb scaffolding procedure (if issued) | **[INTERNAL GAP – human source required]** |
| SRC-ARAMCO-SCAF | Aramco scaffolding requirements | **[INTERNAL GAP]** |
| SRC-SABIC-SCAF | SABIC scaffolding requirements | **[INTERNAL GAP]** |
| SRC-TVTC | TVTC competency / accreditation context | Partial (TVTC pack exists on Desktop) |

## D. Research Packages (Planned)

Mirror of HPWJ RP-* pattern under `docs/research/packages/`:

| Package | Focus |
|---------|--------|
| RP-STD | Standards harvest |
| RP-COMP | Components & SWL |
| RP-TIE | Ties & stability |
| RP-LOAD | Duty classes & design loads |
| RP-INSP | Inspection & tagging |
| RP-TRN | Training & competency schemes |
| RP-INC | Incidents & collapse case studies |
| RP-CLI | Client matrices (when supplied) |
