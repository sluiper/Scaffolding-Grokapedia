...
The **Master Control Register** is the single source of truth. Every chapter maps its controls to MCR item IDs. New thresholds must be added to the MCR (or flagged as candidates) rather than asserted only in a chapter.

**This document reflects the actual filesystem state as of 28 July 2026.**
